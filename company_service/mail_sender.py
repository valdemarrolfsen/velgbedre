...
class Mail_sender:
	...
	def send_welcome_mail(user, passord):
		...
		html_content = '<h2>Hei ' +  user.firstname +'!</h2><h3>Dine personopplysninger er registrert!</h3><p>For at du senere skal kunne ha mulighet til å gå inn og redigere din ønskeliste har vi opprettet et passord du kan benytte til å logge inn.</p><p>Ditt passord er: <strong>' + passord + '</strong></p><p>For å logge inn til din profil gå til</p>'
